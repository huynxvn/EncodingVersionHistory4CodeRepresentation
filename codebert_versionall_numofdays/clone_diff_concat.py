...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VERSION ALL and NUM OF DAYS - Clone Diff Concat")
    ...
    model_log = "Transformer-CodeBert-VersionAll_NumOfDays-Clone Diff Concat, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
