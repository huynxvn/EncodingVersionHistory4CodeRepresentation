...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VERSION ALL and NUM OF DAYS - Clone Pure Code ")
    ...
    model_log = "Transformer-CodeBert-VersionAll_NumOfDays-Clone Pure Code, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
