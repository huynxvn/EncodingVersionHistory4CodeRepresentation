...
if __name__ == '__main__':
    ...
    print("Train for classification - CONCAT - With VERSION ALL + NUMOFDAYS ")
    ...
    # store model result    
    model_log = "Transformer-CodeBert-VersionAll_NumOfDays-Class Concat, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
