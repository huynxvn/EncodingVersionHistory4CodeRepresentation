...
if __name__ == '__main__':
    ...
    print("Train for classification - MAX POOL - With BOTH VERSION ALL + CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-CodeBert-Both_VersionAll_CallGraph-Class Max Pool, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
