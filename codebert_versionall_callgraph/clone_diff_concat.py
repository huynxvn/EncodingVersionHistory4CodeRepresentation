...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with BOTH VERSION MAX + CALL GRAPH - Clone Diff Concat")
    ...
    model_log = "Transformer-CodeBert-BOTH_VersionALl_CallGraph-Clone Diff Concat, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
