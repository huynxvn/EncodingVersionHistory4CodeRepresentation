...
if __name__ == '__main__':
    ...
    print("Train for classification - CONCAT - With BOTH VERSION ALL + CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-CodeBert-Both_VersionAll_CallGraph-Class Concat, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
