...
if __name__ == '__main__':
    ...
    print("Train for classification - PURE CODE - With BOTH VERSION ALL + CALLGRAPH ")
    ...
    # store model result    
    model_log = "Transformer-CodeBert-Both_VersionAll_CallGraph-Class Pure Code, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
