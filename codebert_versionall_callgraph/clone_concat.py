...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with BOTH VERSION MAX + CALL GRAPH - Clone Concat ")
    ...
    model_log = "Transformer-CodeBert-BOTH_VersionALl_CallGraph-Clone ConCat Optimised, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
