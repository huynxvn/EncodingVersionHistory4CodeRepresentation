...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with BOTH VERSION MAX + CALL GRAPH - Clone Max Pool")
    ...
    model_log = "Transformer-CodeBert-BOTH_VersionALl_CallGraph-Clone Max Pool, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
