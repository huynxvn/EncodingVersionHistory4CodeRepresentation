...
if __name__ == '__main__':
    ...
    print("Train for classification - PURE CODE - With VERSIONALL + CALLGRAPH + NUMOFDAYS ")
    ...
    # store model result    
    model_log = "Transformer-CodeBert-VersionAll_CallGraph_NumOfDays-Class Pure Code, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
