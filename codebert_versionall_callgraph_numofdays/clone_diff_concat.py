...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VersionAll+CallGraph+NumOfDays - Clone Diff Concat")
    ...
    model_log = "Transformer-CodeBert-VersionAll_CallGraph_NumOfDays-Clone Diff Concat, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
