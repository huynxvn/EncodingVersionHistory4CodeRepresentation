...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VersionAll+CallGraph+NumOfDays - Clone Pure Code ")
    ...
    model_log = "Transformer-CodeBert-VersionAll_CallGraph_NumOfDays-Clone Pure Code, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
