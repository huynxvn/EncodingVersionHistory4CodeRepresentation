...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VERSION HISTORY - Clone Pure Code ")
    ...
    model_log = "Transformer-CodeBert-Callgraph-Clone Pure Code, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
