...
if __name__ == '__main__':
    ...
    print("Train for clone detection - CODEBERT with VERSION ALL - Clone Max Pool")
    ...
    model_log = "Transformer-CodeBert-VersionAll-Clone Max Pool, %.5f, %.5f, %.5f, %.5f" % (acc, p, r, f)
